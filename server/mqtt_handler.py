...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "smartpoultry.settings")
django.setup()

from devicedata.models import DeviceData, SensorData, ThresholdData  # Import your models

# MQTT settings
MQTT_BROKER = "e6356bea60684fedadf26e979ecd631f.s1.eu.hivemq.cloud"
MQTT_PORT = 8883
MQTT_TOPIC = "esp32_data"
MQTT_THRESHOLD_TOPIC = "threshold_data"
MQTT_USERNAME = "admin"
MQTT_PASSWORD = "5m@rtP0ultry2024"
